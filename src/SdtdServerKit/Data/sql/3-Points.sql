...
CREATE TABLE IF NOT EXISTS T_PointsInfo(
	Id TEXT NOT NULL PRIMARY KEY AUTOINCREMENT,		--玩家跨平台Id
	CreatedAt TEXT NOT NULL,						--创建日期
	EntityId INTEGER NOT NULL,						--玩家实体Id
...
CREATE INDEX IF NOT EXISTS Index_PointsInfo_1 ON T_PointsInfo(EntityId);
